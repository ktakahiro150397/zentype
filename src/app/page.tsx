        ...
        <div className="max-w-4xl mx-auto px-4 py-16 text-center">
          ...
          <div className="space-y-4">
            <p className="text-gray-500">
              Sign in with Google to start tracking your typing progress and
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
          ...
          <div className="mb-8">
            <div className="flex flex-wrap gap-2 justify-center">
              {practiceTexts.map((text) => (
                ...
                >
                  {text.language === "japanese" ? "🎌" : "🇺🇸"} {text.category} (
                  {text.difficulty})
                </button>
              ))}
            </div>
        ...
        {currentText ? (
          <TypingPractice
            ...
            displayText={currentText.displayText}
            inputText={currentText.inputText}
